    ...
    <section id="kontakt" className="bg-[#0A0A0A] py-24 md:py-32 relative overflow-hidden border-t border-[#1A1A1A]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="flex flex-col items-center justify-center mb-10">
          <div className="relative w-40 h-48 md:w-48 md:h-56 mb-6 rounded-3xl overflow-hidden border-[5px] border-primary/20 shadow-[0_0_30px_rgba(220,38,38,0.25)] transform hover:-translate-y-1 transition-transform duration-300">
