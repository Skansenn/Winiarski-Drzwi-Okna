        ...
        <div className="flex flex-col md:flex-row justify-between items-start">
          ...
          <div className="flex flex-col space-y-3 md:items-end md:text-right">
             ...
             <div className="flex items-center gap-3 mb-2 justify-start md:justify-end">
                ...
                <div className="relative w-14 h-14 rounded-full overflow-hidden border-2 border-primary/20 shrink-0 order-first md:order-last shadow-[0_0_15px_rgba(220,38,38,0.2)]">
